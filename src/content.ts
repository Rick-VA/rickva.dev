...
// About
export const about = `Hallo, mijn naam is Rick van Assen, ${age} jaar oud en op dit moment werk ik als Software / DevOps Engineer bij brainhive. Ik ben Backend Developer met focus op Rust en DevOps. Bouw graag aan schaalbare systemen en heb een passie voor het oplossen van technische uitdagingen met Kubernetes. Combineert technische kennis met creativiteit om praktische oplossingen te ontwikkelen die echt werken. Ik vind het leuk om complexe problemen te vereenvoudigen en deel graag kennis met anderen.`
